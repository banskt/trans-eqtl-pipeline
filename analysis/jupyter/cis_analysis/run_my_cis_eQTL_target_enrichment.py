...
for use_LD in LDs:
    ...
    for preproc in preprocs:
        for tejaas_expr in expressions:
            
            if use_LD:
                trans_file = "trans_eqtls.txt.ld_prune"
                out_suffix = ".ld_prune"
                regions_file = "trans_eqtls.txt.ld_regions"
            else:
            ...
            for tissue in tissues:   
                tejaas_file = os.path.join(basepath, summary_dir, tissue, "tejaas", preproc, trans_file)
            ...
            outcisfilename = os.path.join(baseoutdir,f"ciseqtl_enrichment.txt"+out_suffix) 
            targets_outfile = os.path.join(baseoutdir,f"ciseqtl_targets.txt"+out_suffix) 
            ...
            targets_enrichment_outfile = os.path.join(baseoutdir,f"ciseqtl_target_enrichment.txt"+out_suffix)
            # if use_LD:
